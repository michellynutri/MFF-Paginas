...
import { CHECKOUT_URL_MMF_VSL, OFFER_ANCHOR } from "./constants";
...
// variante. Sem checkout configurado, o botão só rola até a oferta.
export function Cta({ children, dataCta, variante, className = "" }: Props) {
  const temCheckout = CHECKOUT_URL_MMF_VSL !== "";
  ...
  return (
    <a
      href={temCheckout ? CHECKOUT_URL_MMF_VSL : OFFER_ANCHOR}
      data-cta={dataCta}
      onClick={temCheckout ? irProCheckout : undefined}
