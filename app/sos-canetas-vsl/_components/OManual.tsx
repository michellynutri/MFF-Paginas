...
const protections = [
  ...
  {
    title: "Garantir que o peso que você perdeu não volte, mesmo quando a caneta parar",
    desc: "Os hábitos construídos agora vão existir independente da medicação.",
  },
  {
      ...
      <div className="max-w-[1180px] mx-auto">
        <div className="grid md:grid-cols-[45%_55%] gap-12 md:gap-16 items-start">
          ...
          <div className="relative flex justify-center md:sticky md:top-12">
            <div className="relative w-full max-w-[400px] aspect-square rounded-lg shadow-[0_24px_60px_rgba(0,0,0,0.4)] overflow-hidden -rotate-3">
          ...
          <div>
            ...
            <div className="font-sans text-[16px] md:text-[18px] leading-[1.7] text-creme/80 space-y-5 mb-10">
              <p>
                Manual S.O.S. Canetas — um sistema de nutrição criado
            ...
            <p className="font-sans text-[16px] md:text-[18px] text-creme font-semibold mt-12 mb-2">
              Um sistema de 7 proteções que garante:
            </p>

            {/* Lista 7 proteções */}
            <ol className="relative mt-6 md:mt-8">
              <div
