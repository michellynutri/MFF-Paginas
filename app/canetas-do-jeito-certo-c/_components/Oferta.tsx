    ...
    <section className="bg-cjc-dia py-16 md:py-24 px-6 md:px-20">
      <div className="max-w-[820px] mx-auto">
            ...
            <li
              ...
              className={`rounded-2xl border p-5 md:p-7 ${
                item.nucleo
                  ...
                  : "border-cjc-dia-linha-suave bg-cjc-dia-superficie"
              }`}
            >
                  ...
                  <div className="flex flex-wrap items-baseline justify-between gap-x-5 gap-y-1 mb-2.5">
                    <h3
                      className={`font-cjc-display text-[19px] md:text-[23px] leading-tight font-semibold ${
                        item.nucleo ? "text-cjc-dia-menta" : "text-cjc-dia-texto"
                      }`}
                    >
                      {item.nome}
                    </h3>
        ...
        {/* A âncora #ingresso pousa aqui, no card que fecha a venda — preço e
            botão na primeira dobra depois do pulo, como nas variantes A e B. */}
        <div
          id="ingresso"
          className="max-w-[620px] mx-auto rounded-3xl border-2 border-cjc-dia-menta/25 bg-cjc-dia-superficie p-7 md:p-11 shadow-[0_24px_60px_rgba(16,32,26,0.12)] scroll-mt-8 md:scroll-mt-14"
        >
