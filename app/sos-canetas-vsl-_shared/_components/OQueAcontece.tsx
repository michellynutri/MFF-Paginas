...
const consequencias = [
  {
    titulo: "O metabolismo desacelera — para o resto do tratamento e depois dele.",
    desc: "Menos massa magra, menos calorias queimadas em repouso. Quando você para, o peso volta.",
  },
  {
    titulo: "O corpo fica flácido em vez de definido.",
    desc: "O que foi embora era músculo, não gordura. O espelho mostra outra história.",
  },
  {
  ...
  {
    titulo:
      "Você fica com medo de parar — e a caneta que era ferramenta vira muleta. E uma muleta cara.",
    desc: "",
  },
];
    ...
    <section className="bg-creme py-16 md:py-24 px-6 md:px-20 relative">
      <div className="max-w-[720px] mx-auto">
        <h2 className="font-serif text-[30px] md:text-[44px] leading-[1.1] md:leading-[1.1] font-medium text-texto mb-10">
          Por que o que você faz agora, nesse momento, é{" "}
          <em className="italic">o mais importante</em> de todo o tratamento
        </h2>
        ...
        <div className="space-y-6 font-sans text-[17px] md:text-[19px] leading-[1.7] text-texto">
          ...
          <p>
            A caneta acaba com a sua fome. Só que ela não escolhe o que o seu
            corpo vai parar de receber — ela só corta. E aí o corpo, recebendo
            pouco e sem entender o que está chegando, faz o que sempre faz
            quando acha que está faltando comida: entra em modo de economia. E
            nesse modo, ele queima músculo antes de gordura.
          </p>
          <p>
            Estudos com GLP-1 indicam que parte significativa do peso perdido
            pode vir de massa magra — não só de gordura — e que um protocolo
            nutricional adequado durante o uso protege o corpo e amplifica o
            resultado. Esse é o ponto que a maioria das pacientes não sabe que
            está perdendo.
          </p>
        </div>
        ...
        <div className="bg-verde-esc text-creme rounded-2xl p-8 md:p-14 my-12 md:my-16 relative overflow-hidden">
          ...
          <p className="font-serif italic text-[22px] md:text-[32px] font-medium leading-[1.3] mb-6 relative z-10">
            O problema nunca foi a caneta. O problema é o que você come — ou
            deixa de comer — enquanto a usa.
          </p>

          <div className="font-sans text-[15px] md:text-[16px] text-creme/80 relative z-10 space-y-4 leading-[1.7]">
            <p>
              A dieta do seu médico é genérica. A da sua nutricionista foi feita
              para um corpo com fome normal. A caneta elimina o apetite. E
              nenhuma orientação convencional foi criada para isso.
            </p>
