...
const itensSem = [
  ...
  "Rosto que murcha, braço flácido, pele sobrando — o corpo mostrando que perdeu o que não devia.",
  "Enjoo que não passa, intestino travado, queda de cabelo, sem disposição.",
  "Quando para a caneta: engorda tudo de volta — às vezes mais do que antes de começar.",
...
const itensCom = [
  ...
  "Rosto definido, braço firme, pele que acompanhou — o corpo que faz as pessoas perguntarem o que você fez.",
  "Efeitos colaterais praticamente sumindo como consequência natural do protocolo.",
  "Hábitos que seguram o resultado mesmo quando a caneta parar.",
    ...
    <section className="bg-sos-creme-soft py-16 md:py-24 px-6 md:px-20">
      <div className="max-w-[1180px] mx-auto">
        <div className="text-center mb-12 md:mb-16">
          ...
          <h2 className="font-serif text-[30px] md:text-[48px] leading-[1.1] md:leading-[1.05] font-medium text-texto max-w-[620px] mx-auto">
            Mesma caneta. <em className="italic">Dois finais</em> completamente
            diferentes.
          </h2>
        </div>
