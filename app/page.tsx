...
export default function Home() {
  return (
    <main>
      ...
      {/* ── Secao 1: Hero ───────────────────────────────────────────────── */}
      <section id="hero" className="bg-creme py-12 lg:py-20">
        <div className="mx-auto grid max-w-6xl gap-16 px-6 lg:grid-cols-[1fr_400px] lg:items-start">
          <div className="flex flex-col">
            ...
            <p className="animate-fade-up animate-delay-200 mt-5 max-w-lg font-sans text-lg leading-relaxed text-verde-esc">
              Mas ninguém te ensinou como a nutrição protege seu corpo — e garante que você não engorde tudo de volta quando parar.
            </p>
      ...
      <section id="identificacao" className="bg-branco py-20">
        <div className="mx-auto max-w-6xl px-5">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            ...
            <div className="stagger-1 rounded-2xl border-t-4 border-t-amber-600 bg-branco p-6 shadow-card transition-all hover:-translate-y-1">
            ...
            <div className="stagger-2 rounded-2xl border-t-4 border-t-verde-vita bg-branco p-6 shadow-card transition-all hover:-translate-y-1">
      ...
      <section className="bg-creme py-20">
        <div className="mx-auto max-w-3xl px-5 text-center">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            ...
            <div className="stagger-1 flex flex-col items-center gap-4 rounded-2xl border border-borda bg-branco p-6 text-center shadow-sm transition-all hover:-translate-y-1">
              <div className="inline-block rounded-xl bg-creme p-3">
            ...
            <div className="stagger-2 flex flex-col items-center gap-4 rounded-2xl border border-borda bg-branco p-6 text-center shadow-sm transition-all hover:-translate-y-1">
              <div className="inline-block rounded-xl bg-creme p-3">
      ...
      <section id="michelly" className="bg-creme py-20">
        <div
          className="mx-auto grid max-w-5xl gap-12 px-5 lg:grid-cols-[40%_60%] lg:items-center"
        >
        ...
        <div className="mx-auto max-w-5xl px-5">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border-l-4 border-l-verde-vita bg-creme p-7">
              <p className="font-serif text-[56px] font-black leading-none text-marrom">19%</p>
            ...
            <div className="stagger-1 rounded-2xl border-l-4 border-l-verde-vita bg-creme p-7">
              <p className="font-serif text-[56px] font-black leading-none text-marrom">2&ordm;</p>
            ...
            <div className="stagger-2 rounded-2xl border-l-4 border-l-verde-vita bg-creme p-7">
              <p className="font-serif text-[56px] font-black leading-none text-marrom">70%</p>
