...
export function HeroVsl({ variant, checkoutUrl = CHECKOUT_URL_VSL_197 }: HeroVslProps) {
  return (
    <section className="bg-creme relative overflow-hidden">
      ...
      <div className="max-w-[1180px] mx-auto relative min-h-[100svh] flex flex-col px-5 md:px-20 py-4 md:py-8">
        ...
        <div className="vsl-stage mt-3 md:mt-5">
          <div className="vsl-player rounded-2xl overflow-hidden shadow-[0_16px_50px_rgba(42,36,24,0.22)] border border-sos-borda-dourada bg-verde-esc">
            ...
            <vturb-smartplayer
              id="vid-6a4ffbd6525aac72484d3762"
      ...
      <Script
        id="vturb-vid-6a4ffbd6525aac72484d3762"
        src="https://scripts.converteai.net/9209a5ac-0a42-43b5-9c1f-7d310e9d3d33/players/6a4ffbd6525aac72484d3762/v4/player.js"
        strategy="afterInteractive"
      />
      <VturbCheckoutUtm variante={"vsl-v05"} />
