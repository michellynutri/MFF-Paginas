    ...
    <div className="sticky top-0 z-50 bg-verde-esc px-4 py-3">
      <div className="mx-auto flex max-w-4xl flex-wrap items-center justify-center gap-2 text-center">
        <span className="font-sans text-sm font-medium text-white">
          Aula 02 no ar agora. Sai do ar em:
        </span>
...
function VideoThumbnail() {
    ...
    return (
      <div className="relative overflow-hidden rounded-2xl">
        <div className="aspect-video w-full">
          <iframe
            src="https://www.youtube.com/embed/p9UxGnxa5uw?autoplay=1&rel=0"
            title="Aula 02 - O que eu pergunto para toda paciente que usa Mounjaro"
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl">
      {/* Thumbnail da Aula 02 */}
      <div className="aspect-video w-full">
        <img
          src="/images/thumb-aula-2.png"
          alt="Aula 02 - O que eu pergunto para toda paciente que usa Mounjaro"
          className="h-full w-full object-cover"
        />
        {/* Play button overlay */}
        <button 
...
export default function CPL2Page() {
  // Data de expiração da Aula 02 (24 de março às 18h)
  const aula02Expiration = new Date("2026-03-24T18:00:00")
  // Data da próxima aula (24 de março às 18h)
  const nextLessonDate = new Date("2026-03-24T18:00:00")

  return (
    <main className="min-h-screen bg-creme">
      {/* ── BLOCO 1: BARRA STICKY ─────────────────────────────────────────── */}
      <StickyBar targetDate={aula02Expiration} />
      ...
      <section className="bg-creme px-5 py-8 lg:py-12">
        <div className="mx-auto max-w-4xl">
          ...
          {/* Avatares de Aula (linha horizontal) - Aula 02 ativa */}
          <div className="mb-10 flex items-center justify-center gap-4 overflow-x-auto pb-2 md:gap-6">
            ...
            <LessonAvatar number="02" date="Assistindo" isActive avatar="/images/avatar-aula-2.png" />
          ...
          {/* Card da Aula Ativa - Aula 02 */}
          <div className="mx-auto max-w-2xl">
            <VideoThumbnail />

            {/* Descrição da Aula 02 */}
            <div className="mt-6 rounded-2xl bg-branco p-6 shadow-card">
              <p className="mb-1 font-sans text-sm font-bold text-verde-esc">AULA 02</p>
              <h2 className="font-serif text-xl font-bold text-marrom md:text-2xl">
                O que eu pergunto para toda paciente que usa Mounjaro antes de montar o protocolo dela.
              </h2>
              <p className="mt-4 font-sans text-base leading-relaxed text-texto/80">
                Existem seis áreas que determinam se você está no caminho da transformação — ou só do emagrecimento. Nessa aula te apresento cada um desses pilares.
              </p>

              {/* Countdown para próxima aula */}
