...
// Variante A do teste A/B — a página original, sem uma vírgula mudada. Quem
// chega pela /canetas-do-jeito-certo cai aqui ou na /-b, no sorteio de 50/50.
// Ela é o controle: enquanto o teste roda, mexer nela invalida a comparação.
//
